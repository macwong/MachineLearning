# https://www.kaggle.com/a45632/keras-starter-4l-added-performance-graph/code
...
df_train = pd.read_json('../_RawData/train.json/data/processed/train.json') # this is a dataframe
