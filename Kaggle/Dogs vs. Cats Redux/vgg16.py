...
class Vgg16():
    ...
    def get_classes(self):
        ...
        fpath = get_file(fname, self.FILE_PATH+fname, cache_subdir='models', cache_dir='datasets')
    ...
    def create(self):
        ...
        fname = 'vgg16.h5'
        model.load_weights(get_file(fname, self.FILE_PATH+fname, cache_subdir='models', cache_dir='datasets'))
...
#                validation_data=val_batches, nb_val_samples=val_batches.samples)
        ...
        spe = int(batches.samples/batches.batch_size)
        
        if spe == 0:
            spe = 1
            
        vs = int(val_batches.samples/val_batches.batch_size)
